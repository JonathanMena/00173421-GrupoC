...
void ListaCircSimple::eliRegistro(void)
{
    ...
    if (aux)
    {
        cout << "El registro fue eliminado exitosamente " << endl << endl;
    }else{
        cout << "Id inexiste " << endl << endl;
    }
}
...
void ListaCircSimple::searchRegistro(void)
{
    int dato = 0;
    bool aux;
    cout << "Id del registro que desea buscar: " << endl; 
    cin >> dato;
    buscar(dato);
}
...
void ListaCircSimple::buscar(int dato)
{
    if(!pInicio){
        ...
        if(s->id == dato) {
            ...
            cout << "Dueño: " << pInicio->nameOwers <<endl;
