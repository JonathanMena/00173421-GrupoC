...
int main()
{
    ...
    ll.addFront(1, "Mojamed Ali", "Admin");
    ll.addFront(2, "Felipe Maduro", "Cliente");
    ll.addFront(3, "Alex Alaobra", "Trabajador");
    ll.addFront(4, "Santiago Guardado", "Cliente");
    ll.addFront(5, "Rene Culotiezo", "Cliente");
    ll.addFront(6, "Benito >:)", "Trabajador");
    ll.addFront(7, "Elsa Pato", "Admin");
    ll.addFront(8, "Juan Calo", "Trabajador");

    //  Anadir al final
    ll.addBack(9, "Simon G Riley" , "Trabajador");
    ll.addBack(10, "Angela Gots", "Cliente");
    ll.addBack(11, "Sor Antonila Ceron", "Cliente");
    ll.addBack(12, "Jonathan Irons", "Cliente");
    ll.addBack(13, "Michael Kords", "Trabajador");
    ll.addBack(14, "Gideon Emery", "Admin");
